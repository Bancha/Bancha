 ...
 *                 autoLoad: true
 *             },
 *             columns: Bancha.scaffold.buildColumns(userModel) // propably not suitable for production
 *         });
 * });
 * </script></code>
 * 
...
Ext.define('Bancha', {
    ...
    createModel: function(modelName, modelConfig) {
        ...
        defaults = {
            ...
            proxy: {
                ...
                ENDIF */
                // IFDEBUG
                directFn: safeDirectFn(stub,'read',modelName), // TODO create ticket on sencha forums
                // ENDIF
                reader: {
                    type: 'json',
                    root: 'data'
    ...
    scaffold: {
        ...
        /**
         * function scaffolding for Ext.grid.Panels on-functions
         */
        gridFunction: {
        ...
        /**
         * Builds grid config from the metadata, for scaffolding purposes
